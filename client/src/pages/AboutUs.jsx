  ...
  return (
    <>
      <div className="relative min-h-screen overflow-hidden isolate bg-black text-orange">
        <div className="pointer-events-none absolute -top-28 -left-28 h-80 w-150 rounded-full bg-orange-500/30 blur-3xl opacity-80" />
        <div className="pointer-events-none absolute -top-28 -right-28 h-80 w-150 rounded-full bg-orange-400/25 blur-3xl opacity-80" />
        ...
        <div className="relative z-10">
          ...
          <section className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto mt-24 px-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="relative rounded-xl p-px group overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_-10px_rgba(249,115,22,0.4)] cursor-default"
                >
                  <span
          ...
          <section className="max-w-5xl mx-auto mt-28 px-6">
            <div className="relative rounded-2xl p-px group overflow-hidden transition-all duration-700 hover:shadow-[0_0_60px_-15px_rgba(249,115,22,0.5)] cursor-default hover:-translate-y-1">
              <span
              ...
              <div className="relative bg-zinc-950 rounded-2xl p-12 text-center border border-zinc-800 group-hover:border-transparent transition-all duration-700 z-10 overflow-hidden">
                <div className="absolute inset-0 bg-linear-to-t from-orange-500/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
                <h2 className="text-3xl font-bold mb-4 relative z-20 text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-white group-hover:to-orange-200 transition-all duration-500">
                  Our Mission
                </h2>
                <p className="text-gray-400 text-lg relative z-20 group-hover:text-gray-300 transition-colors duration-500">
                  To make shared experiences feel truly shared — regardless of
          ...
          <section className="max-w-6xl mx-auto mt-24 px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  icon: (
                    <Zap className="text-orange-500 mx-auto mb-4 w-8 h-8 group-hover:scale-125 group-hover:drop-shadow-[0_0_15px_rgba(249,115,22,0.8)] transition-all duration-500" />
                  ),
                  title: "Simplicity",
                ...
                {
                  icon: (
                    <Shield className="text-orange-500 mx-auto mb-4 w-8 h-8 group-hover:scale-125 group-hover:drop-shadow-[0_0_15px_rgba(249,115,22,0.8)] transition-all duration-500" />
                  ),
                  title: "Accessibility",
                ...
                {
                  icon: (
                    <Heart className="text-orange-500 mx-auto mb-4 w-8 h-8 group-hover:scale-125 group-hover:drop-shadow-[0_0_15px_rgba(249,115,22,0.8)] transition-all duration-500" />
                  ),
                  title: "Community",
                ...
                >
                  ...
                  <div className="relative h-full bg-zinc-950 p-8 rounded-xl border border-zinc-800 group-hover:border-transparent transition-all duration-500 z-10 text-center overflow-hidden">
                    <div className="absolute inset-0 bg-linear-to-b from-orange-500/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    <div className="relative z-20">{value.icon}</div>
          ...
          <section className="max-w-5xl mx-auto mt-28 px-6">
                ...
                <div className="relative h-full bg-zinc-950 p-8 rounded-xl border border-zinc-800 group-hover:border-transparent transition-all duration-500 z-10 overflow-hidden">
                  ...
                  <ul className="space-y-3 relative z-20 text-gray-300">
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        <strong>Sleep:</strong> After 5 minutes of inactivity,
                        our backend enters sleep mode on Render's free tier
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>
                        <strong>Wake-up Time:</strong> First request triggers
                        wake-up (usually 30-90 seconds)
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>
                        <strong>Be Patient:</strong> Initial connection might
                        take time — that's just the backend waking up!
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="relative h-full bg-zinc-950 p-8 rounded-xl border border-zinc-800 group-hover:border-transparent transition-all duration-500 z-10 overflow-hidden">
                  ...
                  <ul className="space-y-3 relative z-20 text-gray-300">
                    <li className="flex items-start gap-3">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>
                        <strong>Overload Protection:</strong> During peak hours,
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>
                        <strong>Free Tier Limits:</strong> Backend has resource
                        constraints on Render's free plan
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-orange-500 mt-1">•</span>
                      <span>
                        <strong>Enjoy & Be Patient:</strong> We're working on
                        scaling! Your patience helps us grow
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="mt-8 p-6 rounded-lg border border-orange-500/30 bg-orange-500/5 relative z-20">
              <p className="text-center text-gray-300 text-sm">
                💡 <strong>Pro Tip:</strong> Create a room and invite friends —
                keeping the connection active prevents sleep mode. Everyone
                benefits from continuous availability!
              </p>
            </div>
          </section>
