      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-4 bg-zinc-900/50 p-8 rounded-3xl border border-white/5 shadow-2xl">
            ...
            <button
              type="submit"
              className="w-full bg-primary hover:bg-primary/90 text-black font-black py-4 rounded-2xl transition-all shadow-xl flex items-center justify-center gap-2 group cursor-pointer"
            >
              Get Started
              <ArrowRight
                size={20}
